...
const i18n = {
  fr: {
    ...
    about_p1:        "Développeur Unity / C# depuis plus de 6 ans, je travaille sur des jeux vidéo en tous genre, des jeux mobiles AAA à la VR en passant par le multijoueur et les prototypes techniques. Chaque projet m'a appris quelque chose de différent et m'a fais explorer de nouvelles techniques, et c'est exactement ça qui me motive.",
    about_p2:        "Je suis polyvalent : gameplay, intégration graphique, création d'outils, optimisation mobile... J'aime résoudre des problèmes concrets et construire des systèmes solides. J'enseigne aussi la programmation et le game design à des jeunes chez Studio XP cette expérience m'a appris à expliquer clairement certain concept technique ainsie qu'a choisir les concept plus simple et fonctionnel en fonction des besoins, une habitude que j'applique maintenant en échange d'équipe.",
    about_p3:        "Passionné de jeux vidéo, de musique electro et d'animés, de modding et streaming, j'ai toujours un projet personnel qui tourne en arrière plan.",
  ...
  en: {
    ...
    about_title:     "About",
    about_p1:        "I've been a Unity / C# developer for over 6 years, working across all kinds of video games — from AAA mobile to VR, multiplayer and technical prototypes. Every project has taught me something different and pushed me to explore new techniques, and that's exactly what keeps me going.",
    about_p2:        "I'm versatile: gameplay, graphical integration, tool development, mobile optimization... I enjoy solving concrete problems and building solid systems. I also teach programming and game design to young people at Studio XP — that experience has taught me to explain technical concepts clearly and to pick simpler, more practical solutions based on actual needs, a habit I now apply in team discussions.",
    about_p3:        "Into video games, electronic music, anime, modding and streaming — there's always a personal project running in the background.",
